...
=encoding UTF8
    ...
    settings {
        ...
        // An optional postfix of "s" or "f" can be used to enforce the use
        // of sharps resp. flats when a transposed chord requires accidentals.
        transpose : 0
        ...
        // Wrap long lines. This may trigger siiue #355.
        wraplines : true
    ...
    html5 {
        ...
        // Delegate rendering overrides for HTML5 output.
        delegates {
            abc {
                // Renderer selection: "abc2svg" (default) or "verovio".
                renderer : abc2svg
            }
        }
