...
=encoding UTF8
    ...
    delegates {
        ...
        abc {
            ...
            html.handler  : abc2svg_html
            html5.handler : abc2svg_html
        }
        ...
        strum {
            ...
            pdf.handler   : strum2xo
            html.handler  : strum2html
            html5.handler : strum2html
        }
        ...
        textblock {
            ...
            pdf.handler   : txt2xform
            html.handler  : txt2html
            html5.handler : txt2html
        }
    }
    ...
    html5 {
        ...
        // Chord diagram layout overrides for HTML5 output.
        diagrams {
            // Layout direction for the chord diagram box when diagrams.show is "right".
            // Values: "vertical" (stacked, default) or "horizontal" (side-by-side).
            direction : "vertical"
        }
    
        // Settings for paged output (with paged.js pagination).
        paged {
    
            // Paper size for pagination (inherits from pdf.papersize if not set).
            papersize : null
    
            // Page margins in points (inherits from pdf margins if not set).
            margintop : null
            marginbottom : null
            marginleft : null
            marginright : null
    
            // Space for page titles and footers (inherits from pdf head/foot space).
            headspace : null
            footspace : null
            ...
            templates {
                ...
                // HTML templates (override html5 templates).
            ...
            // Bundle output settings (externalized CSS and folder output).
            bundle {
                enabled : false
                mode : "minimal"
                html : null
