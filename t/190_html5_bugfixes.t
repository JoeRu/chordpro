...
EOD
    ...
    my @dn_arrows = ($grid_svg =~ /<line x1="([0-9.]+)" y1="36\.00" x2="\1" y2="52\.00" stroke="currentColor" stroke-width="1\.6"\/>/);
    cmp_ok(scalar(@dn_arrows), '>=', 1,
        "Bug 63: Downstroke arrows found in strum row");
    ...
    my @up_arrows = ($grid_svg =~ /<line x1="([0-9.]+)" y1="52\.00" x2="\1" y2="36\.00" stroke="currentColor" stroke-width="1\.6"\/>/);
    cmp_ok(scalar(@up_arrows), '>=', 1,
        "Bug 63: Upstroke arrows found in strum row");
    ...
    my @bar_row0 = ($grid_svg =~ /<line x1="([0-9.]+)" y1="3\.00" x2="\1" y2="23\.00" stroke="currentColor" stroke-width="1"\/>/);
    my @bar_row1 = ($grid_svg =~ /<line x1="([0-9.]+)" y1="35\.00" x2="\1" y2="55\.00" stroke="currentColor" stroke-width="1"\/>/);
    cmp_ok(scalar(@bar_row0), '>=', 1, "Bug 63: Chord row has barlines");
    cmp_ok(scalar(@bar_row1), '>=', 1, "Bug 63: Strum row has barlines");
