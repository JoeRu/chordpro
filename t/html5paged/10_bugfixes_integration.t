...
# Verify Bug 1 fix: Templates resolved correctly
...
like($output, qr/Amazing.*grace/, "Song title/lyrics present");
like($output, qr/Traditional/, "Subtitle present");

# Verify all lines render (including those without leading chords)
like($output, qr/That.*saved.*wretch/, 
